interface Scheme {
  id: string; slug: string; name: string; nameHi: string;
  ministry: string; ministryHi: string; domain: string;
  benefit: number; matchConfidence: number;
  ...
  officeType: string; officeTypeHi: string;
  applyUrl?: string;
}
